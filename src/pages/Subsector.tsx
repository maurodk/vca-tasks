      ...
      <AppLayout>
        <div className="space-y-6 animate-fade-in">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold text-foreground">Subsetor não encontrado</h1>
          </div>
          <Card>
            <CardContent className="p-6 text-center">
              <p className="text-muted-foreground">
                O subsetor que você está procurando não foi encontrado ou você não tem permissão para acessá-lo.
              </p>
              <Button 
                variant="outline" 
                className="mt-4"
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">{subsector.name}</h1>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold">Calendário de Atividades</h2>
          <ActivityCalendar />
        </div>
